...
namespace TestKR1
{
    ...
    public sealed class Test1
    {
        ...
        public void TestMethod1()
        {
            ...
            Assert.IsFalse(KR1.GeometryUtils.ThisTriangleIsExists(testTriangle1));
            KR1.Point hitPoint;
        ...
        public void TestMethod2()
        {
            ...
            Assert.IsTrue(KR1.GeometryUtils.ThisTriangleIsExists(testTriangle2));
            KR1.Point hitPoint;
        ...
        public void TestMethod3()
        {
            ...
            KR1.Triangle testTriangle3 = new(new KR1.Point(0, 10, 0), new KR1.Point(0, 51, 0), new KR1.Point(15, 50, 70));
            Assert.IsTrue(KR1.GeometryUtils.ThisTriangleIsExists(testTriangle3));
            KR1.Point hitPoint;
            KR1.Ray testRay3 = new(0, 0, 0, 0, 90);

            Assert.IsFalse(KR1.GeometryUtils.RayTriangleIntersect(testRay3, testTriangle3, out hitPoint));
